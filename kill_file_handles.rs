...
//! File Handle Killer (Windows Only)
//!
//! Finds and terminates processes that are holding file handles to a specific
//! file or directory. Useful for resolving "file in use" errors.
//!
//! Usage:
//!   rust-script kill-file-handles.rs [OPTIONS] <path>
//!
//! Options:
...
//!
//! Examples:
//!   rust-script kill-file-handles.rs build/
//!   rust-script kill-file-handles.rs --force windows/flutter/ephemeral
//!   rust-script kill-file-handles.rs -v "C:\path\to\file.dll"
//!
//! Note: Requires Windows and uses Handle.exe from Sysinternals Suite.
//!
//! ```cargo
//! [dependencies]
